...
//
//import com.sapiens.debezium.service.EMPLOYEE_Service;
//
...
//
//@Component
//public class DebeziumListenerEMPLOYEE {
//
...
//
//	private DebeziumListenerEMPLOYEE(EMPLOYEE_Service sourceRecordChangeValue) throws IOException {
//		// this.engine =
//		// EmbeddedEngine.create().using(employeeConnector).notifying(this::handleEvent).build();
////		CharsetDecoder decoder = Charset.forName("UTF-8").newDecoder();
////		FileInputStream input = new FileInputStream(new File("debezium.properties"));
...
//
//		this.employeeService = sourceRecordChangeValue;
//	}
//
